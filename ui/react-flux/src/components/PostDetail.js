        ...
        <div className="post">
            {
                ...
                null : <aside className="actions">
                    <Link to={`/react_flux/post/edit/${props.post.id}`} className="btn btn-default">
            ...
            {
                props.post.published_date ? 
                <Link to={`/react_flux/comment/${props.post.id}`} className="btn btn-default">Add Comment</Link> : null
            }
        </div>
    );
}
